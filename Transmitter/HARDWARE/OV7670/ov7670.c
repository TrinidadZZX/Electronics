...
u8 OV7670_Init(void)
{
    ...
    RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOA|RCC_APB2Periph_GPIOB|RCC_APB2Periph_GPIOC|RCC_APB2Periph_GPIOD|RCC_APB2Periph_GPIOE|RCC_APB2Periph_GPIOG|RCC_APB2Periph_AFIO, ENABLE);	 //使能相关端口时钟
    ...
    GPIO_InitStructure.GPIO_Pin  = 0XFF00; //PE8~15 输入上拉
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IPU;
