...
Gui_StrCenter(0,lcddev.height-18,WHITE,BLUE,"University of Science and Technology of China",16,1);//居中显示
//绘制测试区域
...
void main_test(void)
{
	...
	Gui_StrCenter(0,30,RED,BLUE,"Haoran Li",16,1);//居中显示
	Gui_StrCenter(0,60,BLUE,BLUE,"Rain Lou",16,1);//居中显示	
	Gui_StrCenter(0,90,YELLOW,BLUE,"Trinidad",16,1);//居中显示
	delay_ms(1500);		
	delay_ms(1500);
}
