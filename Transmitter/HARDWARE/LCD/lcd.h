...
#define	LCD_RST_SET	GPIOE->BSRR=1<<4
#define	LCD_CS_SET  GPIOE->BSRR=1<<3
#define	LCD_RS_SET	GPIOE->BSRR=1<<2 
#define	LCD_WR_SET	GPIOE->BSRR=1<<1
#define	LCD_RD_SET	GPIOE->BSRR=1<<0
					
#define	LCD_RST_CLR GPIOE->BRR=1<<4	
#define	LCD_CS_CLR  GPIOE->BRR=1<<3
#define	LCD_RS_CLR  GPIOE->BRR=1<<2
#define	LCD_WR_CLR  GPIOE->BRR=1<<1 
#define	LCD_RD_CLR  GPIOE->BRR=1<<0
