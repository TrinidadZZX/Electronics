...
#define	LCD_RST_SET	GPIOE->BSRR=1<<11
#define	LCD_CS_SET  GPIOE->BSRR=1<<10 
#define	LCD_RS_SET	GPIOE->BSRR=1<<9 
#define	LCD_WR_SET	GPIOE->BSRR=1<<8
#define	LCD_RD_SET	GPIOE->BSRR=1<<7 
					
#define	LCD_RST_CLR GPIOE->BRR=1<<11 	
#define	LCD_CS_CLR  GPIOE->BRR=1<<10 
#define	LCD_RS_CLR  GPIOE->BRR=1<<9
#define	LCD_WR_CLR  GPIOE->BRR=1<<8 
#define	LCD_RD_CLR  GPIOE->BRR=1<<7 
